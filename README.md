...
These projects are part of my Data Science continuing education at IU International University of Applied Sciences.
...
- **LC-MS Quality Monitor** — a tool for detecting retention time drift and intensity anomalies in chromatographic data, built on simulated data modelled after real instrument behaviour
- **Own laboratory data analysis** — exploratory analysis of real instrument data from my previous research work (R)
...
*Always happy to connect with people working at the chemistry–data science interface.*
